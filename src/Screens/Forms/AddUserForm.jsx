...
export default function AddUserForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Users account created successfully!');
      ...
      console.error("Error creating Users account: ", error);
      alert('Error creating Users account');
    }
  };
  ...
  return (
    <div className="form-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Link to="/ManageUsers" type="button" className="back-btn"> Back</Link>
