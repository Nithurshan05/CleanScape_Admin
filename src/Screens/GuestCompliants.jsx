...
const GuestComplaints = () => {
  ...
  const updateComplaintStatus = async (complaintId, status, color) => {
    try {
    ...
    <div className="manage-complaints">
      ...
      <main className="main-content">
        <header className="main-header">
          <h1>Guest Complaints Confirmation</h1>
        </header>
        ...
        <div className="complaint-list">
          {complaints.map((complaint) => (
            <div
              ...
              style={{ backgroundColor: complaint.color || '#e6ffed' }}
            >
      ...
      {selectedComplaint && (
        <div className="overlay">
          <div className="details-box form-container">
            ...
            <div className="form-group">
              <p><strong>Category:</strong> Guest Complaint</p>
            </div>
            <div className="form-group">
